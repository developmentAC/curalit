...
./curalit search -k "$kw1" -k "$kw2" -k "$kw3" -d ./data -o "$results_dir"
...
./curalit db-build -k "$kw1" -k "$kw2" -k "$kw3" -d "$data_dir"

echo -e "${BLUE}INFO:${NC} Command to ask a question"
myQ="Describe a research project concerning prosthetics. Please provide several articles to read on the subject. Comment on the articles and provide a summary of the research project. Please provide references to the articles."
...
echo -e "${BLUE}INFO:${NC} Command to ask a question"
myQ="MY next question is: Describe a research project concerning joint analysis using statistics. Please provide several articles to read on the subject. Comment on the articles and provide a summary of the research project. Please provide references to the articles."
